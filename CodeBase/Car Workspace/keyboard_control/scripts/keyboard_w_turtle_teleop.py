...
class KeyBoard:
    def __init__(self):
        ...
        self.pub = rospy.Publisher("/vesc/high_level/ackermann_cmd_mux/input/nav_0", AckermannDriveStamped, queue_size=10) # Publish to /vesc/high_level/ackermann_cmd_mux/input/nav_0
        self.sub = rospy.Subscriber("/keyboard", Twist, self.callback) # Subscribe to /keyboard from teleop_key
    ...
    def callback(self, msg):
        ...
        if msg.linear.x < 0 and msg.angular.z == 0: # KEY_DOWN
            ...
            self.ack_msg.drive.steering_angle = -.3
