...
class WallFollow:
    ...
    def __init__(self):
        ...
        self.min_angle = -0.4
        self.max_angle = 0.4
        self.servo_offset = 0 # offset of the car, 0 for sim, ? for real car
    ...
    def pid_control(self, error, prev_error):
        ...
        angle = self.kp * error + self.kd * derivative + self.ki # TODO: PID control equation to calculate the angle control command
    ...
    def lidar_callback(self, data):
        ...
        #TODO: Compute steering angle and velocity using current error and previous error
