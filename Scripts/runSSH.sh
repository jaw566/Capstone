...
sshpass -p 'password' scp runClose.sh runStop.sh runLaunch.sh runSim.sh carStop.sh nvidia@10.18.92.160:'~/Documents'

#Create the ssh screen - to enteract and close files with
sshpass -p 'password' ssh -T nvidia@10.18.92.160 'screen -dmS Ssh'
...
sshpass -p 'password' ssh -T nvidia@10.18.92.160 "screen -dmS roscore ./runCar.sh"
