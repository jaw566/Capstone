...
sshpass -p 'password' scp runClose.sh runStop.sh runLaunch.sh runSim.sh carStop.sh nvidia@10.18.92.120

#Create the ssh screen - to enteract and close files with
sshpass -p 'password' ssh -T nvidia@10.18.92.120 'screen -dmS Ssh'
...
sshpass -p 'password' ssh -T nvidia@10.18.92.120 "screen -dmS roscore ./runCar.sh"
