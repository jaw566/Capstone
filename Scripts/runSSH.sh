...
sshpass -p 'doan_1234' scp runClose.sh runStop.sh runLaunch.sh runSim.sh carStop.sh nvidia@10.18.92.160:'~/Documents'
...
sshpass -p 'doan_1234' ssh -T nvidia@10.18.92.160 "screen -dmS roscore ./runCar.sh"
